...
@Getter
@AllArgsConstructor
public class AssetDetailedDto implements Serializable {
    ...
    private final List<AssetOrderChangeHistoryDto> orders;
    private final List<AssetChangeHistoryDto> changeHistory;
